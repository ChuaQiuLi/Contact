    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addContactEdt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String names = name.substring(0,1).toUpperCase();
                String nameCap = names + name.substring(1);
                ...
                if (TextUtils.isEmpty(name) && TextUtils.isEmpty(email) && TextUtils.isEmpty(phone)) {
                    Toast.makeText(NewContact.this, "Please enter the data in all fields. ", Toast.LENGTH_SHORT).show();

                }

                else {
                    // calling a method to add contact.
                    addContact(nameCap, email, phone);
                }
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                Intent i = new Intent(NewContact.this, MainActivity.class);
                startActivity(i);
            }
